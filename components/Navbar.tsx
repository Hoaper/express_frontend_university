...
export default function Navbar() {
    ...
    const navigation = [
        ...
        { name: 'Books', href: '/books', current: path === "/books" },
    ]
    ...
    return (
        <Disclosure as="nav" className="bg-[#76603d]">
            {({ open }) => (
                <>
                                ...
                                {token
                                    ?
                                        <Menu as="div" className="relative ml-3">
                                            <div>
                                                <Menu.Button className="relative flex rounded-full bg-[#6f4e39] p-2 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                    ...
                                    :
                                        <div>
                                            <a href={"/login"} className="text-white px-3 py-2 mr-2 rounded-md text-sm font-medium">Login</a>
